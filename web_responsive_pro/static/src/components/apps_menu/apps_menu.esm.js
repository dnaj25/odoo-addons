...
import {AppMenuItem} from "@web_responsive_pro/components/apps_menu_item/apps_menu_item.esm";
import {AppsMenuSearchBar} from "@web_responsive_pro/components/menu_searchbar/searchbar.esm";
...
Object.assign(AppsMenu, {
    template: "web_responsive_pro.AppsMenu",
    props: {
        slots: {
            type: Object,
            optional: true,
