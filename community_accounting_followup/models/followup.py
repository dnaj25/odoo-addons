...
class FollowupLine(models.Model):
    ...
    def default_get(self, default_fields):
        ...
        if self.env.ref('community_accounting_followup.email_template_community_accounting_followup_default'):
            values['email_template_id'] = self.env.ref('community_accounting_followup.email_template_community_accounting_followup_default').id
        return values
